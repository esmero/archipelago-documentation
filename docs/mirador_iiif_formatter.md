...
You can find the main Digital Object default example of the `Strawberry Field Media Formatter using the Mirador * IIIF Viewer plugin` settings configuration form at:
...
### Digital Object Collection/Compound Parent using Mirador

You can find two examples of Digital Object Collection/Compound Parent view modes using Mirador, each configured slightly differently than the main Digital Object example described above, to account for the needs of displaying collection or compound parent object data.

1. Digital Object Collection with Mirador Viewer
    - `admin/structure/types/manage/digital_object_collection/display/digital_object_collection_with_mirador_viewer`
    - Through the `Manage` menu > `Structure` > Content types > Digital Object Collection > Manage display > Select 'Digital Object Collection with Mirador Viewer'
    - IIIF Manifest generated by the "iiifmanifest3collection" Metadata Data Expose Endpoint.

2. Digital Object Creative Work Series (Compound Parent) with Mirador Viewer
    - `admin/structure/types/manage/digital_object_collection/display/digital_object_creative_work_series_with_mirador_viewer`
    - Through the `Manage` menu > `Structure` > Content types > Digital Object Collection > Manage display > Select 'Digital Object Creative Work Series with Mirador Viewer'
    - IIIF Manifest generated by the "iiifmanifest3cws" Metadata Data Expose Endpoint.
