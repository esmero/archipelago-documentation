...
The following Strawberryfield Formatters are shipped and configured with corresponding [View Modes](webformsasinput.md#default-view-modes-bundled-in-archipelago) in Archipelago.
...
You can see the full list of [Default View Modes included in Archipelago here](webformsasinput.md#default-view-modes-bundled-in-archipelago).
