---
title: Citation Schema Reference
tags:
  - Citations
  - Bibliographies
  - Reference 
...
## JSON Schema for Citation Style Language (CSL) Input Data

The below schema is provided for reference. The source for this schema provided by the [CSL Project](https://citationstyles.org/) is [csl-data.json](https://github.com/citation-style-language/schema/blob/master/schemas/input/csl-data.json). For usage see the [Citations and Bibliographies Guide](citations_bibliographies.md).
