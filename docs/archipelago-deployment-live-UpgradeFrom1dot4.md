...
from the new release and, as described in the general (from zero) [deployment instructions](https://github.com/esmero/archipelago-deployment-live/blob/1.5archipelago-deployment-live-readme.md) replace the `http://esmero-web` with your real domain.
