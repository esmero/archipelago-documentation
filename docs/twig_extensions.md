...
!!! info "bibliography"
    ...
    The `bibliography` filter is used to generate bibliographies in Citation Style Language. For more info please see [Citations and Bibliographies](citations_bibliographies.md)
